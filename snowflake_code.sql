...
CREATE DATABASE DE_PROJECT_WEATHER;

-- Switch to the newly created database
USE DATABASE DE_PROJECT_WEATHER;
...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::059237997405:role/AWSToSnowflake'
  storage_allowed_locations = ('s3://de-weather/snowflake/');
